...
- [ ] ISSUE-052: [Developer] Enhance Synthetic Data Generation for Complex Scenarios [IN PROGRESS]
    *   **[Architect] Subtask 1: Design `synthetic_data_generator.py` module and API for complex signals (AM/FM, impulses).** [TODO]
    *   **[Developer] Subtask 2: Implement core generation functions in `synthetic_data_generator.py`.** [OPEN]
    *   **[Developer] Subtask 3: Create a Streamlit UI for interactive synthetic data generation and download.** [OPEN]
    *   **[QA/Expert] Subtask 4: Add unit tests for `synthetic_data_generator.py`.** [OPEN]
